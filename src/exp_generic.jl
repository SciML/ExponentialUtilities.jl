...
function naivemul!(C::StridedMatrix{T},
                   A::StridedMatrix{T},
...
@generated function naivemul!(C::AbstractMatrix{T},
                              A,
                              B,
                              Maxis,
                              Naxis,
...
function exp_pade_p!(y1::AbstractMatrix{T},
                     y2::AbstractMatrix{T},
                     x::AbstractMatrix,
                     ::Val{13},
                     ::Val{13}) where {T}
    ...
    for c in (2.8101705462199623e-15,
