...
function KrylovSubspace{T, U}(n::Integer,
    ...
    return KrylovSubspace{T, U, real(T), Matrix{T}, Matrix{U}}(maxiter,
                                                               maxiter,
                                                               augmented,
                                                               zero(real(T)),
                                                               V,
...
"""
function arnoldi_step!(j::Integer,
                       iop::Integer,
                       A::AT,
                       V::AbstractMatrix{T},
                       H::AbstractMatrix{U},
                       n::Int = -1,
                       p::Int = -1) where {AT, T, U}
...
"""
function arnoldi!(Ks::KrylovSubspace{T1, U},
                  A::AT,
                  b;
                  tol::Real = 1e-7,
...
Take the `j`:th step of the Lanczos iteration.
"""
function lanczos_step!(j::Integer,
                       A,
                       V::AbstractMatrix{T},
                       u::AbstractVector{U},
                       v::AbstractVector{B},
...
Hermitian matrices.
"""
function lanczos!(Ks::KrylovSubspace{T1, U, B},
                  A::AT,
                  b;
                  tol = 1e-7,
