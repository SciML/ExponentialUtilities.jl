...
"""
function expv_timestep!(u::AbstractVector{T},
                        t::tType,
                        A,
                        b::AbstractVector{T};
...
function expv_timestep!(U::AbstractMatrix{T},
                        ts::Vector{tType},
                        A,
                        b::AbstractVector{T};
                        kwargs...) where {T <: Number, tType <: Real}
...
"""
function phiv_timestep!(u::AbstractVector{T},
                        t::tType,
                        A,
                        B::AbstractMatrix{T};
                        kwargs...) where {T <: Number, tType <: Real}
...
function phiv_timestep!(U::AbstractMatrix{T},
                        ts::Vector{tType},
                        A,
                        B::AbstractMatrix{T};
                        tau::Real = 0.0,
                        m::Int = min(10, size(A, 1)),
                        tol::Real = 1e-7,
    ...
    while t < tend # time stepping loop
        ...
        @inbounds for l in 1:(p - 1) # compute cl = t^l/l!
        ...
        if adaptive
            ...
            while omega > delta # inner loop of Algorithm 3
                m_new, tau_new, q, kappa = _phiv_timestep_adapt(m,
                                                                tau,
                                                                epsilon,
                                                                m_old,
                                                                tau_old,
...
function _phiv_timestep_adapt(m,
                              tau,
                              epsilon,
                              m_old,
                              tau_old,
