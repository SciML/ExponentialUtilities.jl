...
@inline function exp_13(A)
    T=promote_type(eltype(A),Float64)
    A_copy=similar(A,T); A_copy .= A;
    return exp_13!(cache,A_copy)
end

@inline function exp_13!(cache,A)
    ...
    # Computation order: C A2 A4 A6 Ub3 Ub Uc U Vb3 Vb V Z X P S1 S2 S3 S4 S5 S6 S7 S8
    # Computing C = x*A+x*I
    coeff1=0.00390625
    coeff2=0.0
